...
// raw data with Serial.print, Sprintf functions present far better data display output.
// Better still, without the work of configuring Sprintf, use of an external Terminal
// program allows for the best control and display of EEPROM read/write data.
// One such terminal program that I find easy and very effective is "Tera Terminal".
...
//---------------------------------------------------------------------------
// start of SPI read a single byte from the chip selected (cs) and from location (adr) 
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// start of SPI write a single byte TO selected chip (cs) and TO location (adr)  
//---------------------------------------------------------------------------
